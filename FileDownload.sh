...
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" -C mychannel -n private -c '{"function":"UploadFile","Args":["praabe","192.168.2.100:5001"]}' --transient "{\"file_properties\":\"$FILE_PROPERTIES\"}"
sleep 3
echo "45MB===========45MB"
for i in {1..21}
do
peer chaincode query -C mychannel -n private -c '{"function":"GetFileFromIPFS","Args":["Org1MSPPrivateCollection","MemberKey1","192.168.2.100:5001","niceab1"]}'
done
...
for i in {1..21}
do
peer chaincode query -C mychannel -n private -c '{"function":"GetFileFromIPFS","Args":["Org1MSPPrivateCollection","MemberKey1","192.168.2.100:5001","niceab2"]}'
done
...
for i in {1..21}
do
peer chaincode query -C mychannel -n private -c '{"function":"GetFileFromIPFS","Args":["Org1MSPPrivateCollection","MemberKey1","192.168.2.100:5001","niceab3"]}'
done
...
for i in {1..21}
do
peer chaincode query -C mychannel -n private -c '{"function":"GetFileFromIPFS","Args":["Org1MSPPrivateCollection","MemberKey1","192.168.2.100:5001","niceab4"]}'
done